...
describe('Service Tests', () => {
  describe('Cryptocurrency Service', () => {
    ...
    let elemDefault: ICryptocurrency;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Cryptocurrency(0, 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Cryptocurrency', () => {
        ...
        service.create(new Cryptocurrency()).subscribe(resp => (expectedResult = resp.body));
